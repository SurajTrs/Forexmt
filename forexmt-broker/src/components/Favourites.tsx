        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div>
              ...
              <p className="text-sm text-gray-500">Trade ForexMT's full product offering</p>
            ...
            <div className="mt-6 flex items-center gap-4">
              <div className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-sm">
                ...
                <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">
                  ForexMT <span className="text-blue-600">Favourites</span>
                </h2>
              ...
              <div className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-sm">
                ...
                <h3 className="text-lg font-medium text-gray-900">ForexMT Mobile App</h3>
                <span className="text-amber-400" aria-label="5 stars" title="5 stars">★★★★★</span>
              </div>
            </div>
