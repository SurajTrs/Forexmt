...
export default function Footer() {
  ...
  const socials: { label: string; href: string; Icon: IconType }[] = [
    { label: "Twitter", href: "https://twitter.com/xmgroup", Icon: FaTwitter },
    { label: "LinkedIn", href: "https://linkedin.com/company/xmgroup", Icon: FaLinkedin },
    { label: "Facebook", href: "https://facebook.com/xmgroup", Icon: FaFacebook },
    { label: "Instagram", href: "https://instagram.com/xmgroup", Icon: FaInstagram },
  ];
