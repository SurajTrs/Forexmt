        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div>
            <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md px-6 sm:px-8 py-8 sm:py-10 shadow-2xl">
              <span className="text-sky-400 font-semibold uppercase tracking-widest">Learning Center</span>
              ...
              <p className="mt-4 text-gray-300 text-base sm:text-lg max-w-xl">
                From basics to advanced strategies. Continue at your own pace and accelerate your financial mindset.
              </p>
              <div className="mt-6 flex items-center gap-3">
                <a href="#education-cards" className="inline-flex items-center justify-center rounded-2xl bg-white px-6 sm:px-7 py-3 text-[15px] sm:text-base font-semibold text-slate-900 shadow-sm ring-1 ring-white/10 transition hover:bg-white/90">Get Started</a>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative mx-auto w-[260px] sm:w-[320px] md:w-[360px] aspect-[9/16] rounded-3xl ring-1 ring-white/10 shadow-2xl overflow-hidden">
              <Image src="/Bonus.png" alt="Education" fill className="object-cover" priority />
            </div>
          </div>
        </div>
      </div>
