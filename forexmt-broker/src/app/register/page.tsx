                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="terms" className="text-gray-300">
                        By signing up, you agree to ForexMT's <a href="/terms" className="text-sky-400 hover:underline">Terms and Conditions</a> and <a href="/privacy" className="text-sky-400 hover:underline">Privacy Policy</a>.
                      </label>
                    </div>
                  </div>
