...
export default function TurboStocksPairsTable({ onTradeSymbol }: { onTradeSymbol?: (symbol: string) => void }) {
  return (
    <section className="relative bg-white py-12 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h3 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">Turbo Stocks</h3>
            <p className="text-slate-600 mt-1">Popular turbo stock CFDs with competitive conditions.</p>
          </div>
