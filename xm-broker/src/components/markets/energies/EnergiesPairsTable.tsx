...
const DATA = [
  ...
  { symbol: "NATGAS", name: "Natural Gas", avg: 8.0, low: 6.0, leverage: 100 },
];

export default function EnergiesPairsTable({ onTradeSymbol }: { onTradeSymbol?: (symbol: string) => void }) {
  return (
    <section className="relative bg-white py-12 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h3 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">Energies</h3>
            <p className="text-slate-600 mt-1">Trade Oil and Natural Gas with competitive conditions.</p>
          </div>
