...
const cards: Card[] = [
  {
    ...
    desc:
      "Use ForexMT bonuses to increase your capital, open larger trades, and seize more opportunities.",
    span: "lg:col-span-4",
    variant: "light",
    img: "/Bonus.png",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-slate-900">
            Discover The ForexMT Advantage
          </h2>
          <p className="mt-3 text-slate-600">
            You're only as good as your broker, and ForexMT is as good as it gets.
          </p>
        </div>
