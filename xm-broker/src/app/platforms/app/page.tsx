  ...
  return (
    <>
      ...
      <AppZigzagSection
        ...
        subtitle="Tap into your full potential with the all‑in‑one, award‑winning XM app. All XM accounts, products, and services are just a few taps away."
        imageSrc="/mobile.png"
        imageAlt="XM App mobile preview"
      />
      <AppZigzagSection
        title="Start Trading"
        subtitle="Open an XM account from the app within minutes."
        imageSrc="/shares.png"
