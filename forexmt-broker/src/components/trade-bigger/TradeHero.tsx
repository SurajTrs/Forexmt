...
export default function TradeHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-sky-50 to-white pt-28 pb-16 sm:pt-36 sm:pb-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.p
          ...
          className="mt-4 max-w-2xl mx-auto text-slate-600 text-base sm:text-lg"
        >
